...
class ShowAutoTime extends StatefulWidget {
  final UserModel userModel;
  const ShowAutoTime({Key? key, required this.userModel}) : super(key: key);

  @override
  _ShowAutoTimeState createState() => _ShowAutoTimeState();
}

class _ShowAutoTimeState extends State<ShowAutoTime> {
  UserModel? userModel;
  LatLng? latlng;
  ...
  ElevatedButton buildEditButton() {
    return ElevatedButton.icon(
        onPressed: () =>
            Navigator.pushNamed(context, MyConstant.routeEditProfileDriver)
                .then(
