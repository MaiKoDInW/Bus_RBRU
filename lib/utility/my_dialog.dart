...
class MyDialog {
  Future<Null> showProgressDiolog(BuildContext context) async {
    showDialog(
      context: context,
  ...
  Future<Null> alertLocationService(
      BuildContext context, String title, String messge) async {
    showDialog(
      context: context,
  ...
  Future<Null> normalDialog(
    ...
    showDialog(
      ...
      builder: (context) => SimpleDialog(
        title: ListTile(
          leading: ShowImage(path: MyConstant.image5),
          title: ShowTitle(
            title: title,
            textStyle: MyConstant().h2Style(),
          ),
