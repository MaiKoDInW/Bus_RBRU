...
class _AuthenState extends State<Authen> {
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              if (formKey.currentState!.validate()) {
                ...
                checkAutthen(user: user, password: password);
              }
            },
            child: Text('Login'),
          ),
  ...
  Future<Null> checkAutthen({String? user, String? password}) async {
            ...
            switch (type) {
              case 'Student':
                Navigator.pushNamedAndRemoveUntil(
                    context, MyConstant.routeStudent, (route) => false);
                break;
              case 'Driver':
                Navigator.pushNamedAndRemoveUntil(
                    context, MyConstant.routeDriver, (route) => false);
                break;
              default:
            }
          } else {
